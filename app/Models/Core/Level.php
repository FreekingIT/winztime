...
class Level extends Model
{
    ...
    public $sortable =['id', 'name', 'start_count', 'end_count', 'status', 'created_at', 'updated_at'];
    protected $fillable = ['id', 'name', 'start_count', 'end_count', 'status', 'created_at', 'updated_at'];
   ...
   public function getlevel($id){
       ...
       $level = DB::table('levels')->where('id', '=', $id)->get();
...
public function levelupdate($level_id,$name,$start_count,$end_count){

         //insert record
         $levels_id = DB::table('levels')->where('id', '=', $level_id)->update([
             'name'                      =>   $name,
             'updated_at'                =>   date('Y-m-d H:i:s'),
