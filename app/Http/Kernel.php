...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
      ...
      'Customer' => \App\Http\Middleware\RedirectIfNotCustomer::class,
        ...
        'view_campaign' => \App\Http\Middleware\campaign\view_campaign::class,
        'edit_campaign' => \App\Http\Middleware\campaign\edit_campaign::class,
        'delete_campaign' => \App\Http\Middleware\campaign\delete_campaign::class,
        'add_campaign' => \App\Http\Middleware\campaign\add_campaign::class,
