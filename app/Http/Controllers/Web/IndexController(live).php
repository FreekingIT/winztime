...
class IndexController extends Controller
{
    ...
    public function network(Request $request)
    {
        ...
        // $apikey = "OTg5Nzc4YzctNWZiNC00YzA1LTgwYjQtYmEzMTljYTk4ZDBlOjc0ZDI3NzdiLTkzOTAtNDUxOS1hMmYyLTMyNDFlNDkyNDljOQ==";     // enter your API key here
        ...
        $postData = array(
            ...
            "merchantAttributes" => array(
                "redirectUrl" => "https://winztime.com/checkout",
        ...
        // $postData->merchantAttributes->redirectUrl="http://134.119.189.170:90/shukran/public/checkout";

        // $outlet = "53dfbb33-b5d2-41c2-ba48-0beb2bf40af7";
        $outlet = "36c3aa8a-c055-45eb-b534-5cdbab91769d";
        $token = $access_token;
        // echo($token);
    ...
    public function network_get(Request $request)
    {
        ...
        // $apikey = "OTg5Nzc4YzctNWZiNC00YzA1LTgwYjQtYmEzMTljYTk4ZDBlOjc0ZDI3NzdiLTkzOTAtNDUxOS1hMmYyLTMyNDFlNDkyNDljOQ=="; 
        $apikey = "YThjMjA2MWYtNTBmYS00ZDA1LTliZjgtODZlM2I4ZTRkOGJlOjUyNDI5MGMxLTQ1MTQtNDk4My05ZWY1LTU5Yjc5MGIyODYyNw==";     // enter 
        ...
        curl_setopt($ch, CURLOPT_URL, "https://api-gateway.ngenius-payments.com/transactions/outlets/" . $outlet . "/orders/" . $ref . "");
