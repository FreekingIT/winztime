...
Route::group(['middleware' => ['installer']], function () {
    ...
    Route::group(['namespace' => 'AdminControllers', 'middleware' => 'auth', 'prefix' => 'admin'], function () {
        ...
        // Home page winners
        Route::get('/home_winners', 'AdminWinnerController@homewinner');
        Route::get('/add_home_winner', 'AdminWinnerController@addhomewinner');
        Route::post('/addNewHomeWinner', 'AdminWinnerController@addNewHomeWinner');
        Route::get('/editwinner/{id}', 'AdminWinnerController@editwinner');
        Route::post('/updateWinner', 'AdminWinnerController@updateWinner');
        Route::post('/deleteWinner/', 'AdminWinnerController@deleteWinner');
...
//customers
    ...
    Route::group(['prefix' => 'admin/ticket', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        Route::get('/display', 'TicketController@display')->middleware('view_ticket');
        Route::get('/add', 'TicketController@add')->middleware('add_ticket');
        Route::post('/insert', 'TicketController@insert')->middleware('add_ticket');
        Route::get('/edit/{id}', 'TicketController@edit')->middleware('edit_ticket');
        Route::post('/update', 'TicketController@update')->middleware('edit_ticket');
        Route::post('/delete', 'TicketController@delete')->middleware('delete_ticket');
        Route::get('/filter', 'TicketController@filter')->middleware('view_ticket');
        Route::get('/update/status/{id}', 'TicketController@updateStatus');
        Route::get('/update/status/two/{id}', 'TicketController@updateStatustwo');
        Route::get('/updatename/{id}', 'TicketController@updateName');
        Route::post('/savename', 'TicketController@saveName');

    });   
    Route::group(['prefix' => 'admin/level', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        Route::get('/display', 'LevelController@display')->name('view_level');
        Route::get('/add', 'LevelController@add')->name('add_level');
        Route::post('/insert', 'LevelController@insert')->name('add_level');
        Route::get('/edit/{id}', 'LevelController@edit')->name('edit_level');
        Route::post('/update', 'LevelController@update')->name('edit_level');
        Route::post('/delete', 'LevelController@delete')->name('delete_level');
        Route::get('/filter', 'LevelController@filter')->name('view_level');
    });  
    Route::group(['prefix' => 'admin/winners', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
       Route::get('/display', 'WinnerController@display')->name('view_winner');
       Route::get('/add', 'WinnerController@add')->name('add_winner');
    }); 
    Route::group(['prefix' => 'admin/campaign', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        Route::get('/display', 'CampaignController@display')->middleware('view_campaign');
        Route::get('/add', 'CampaignController@add')->middleware('add_campaign');
        Route::post('/insert', 'CampaignController@insert')->middleware('add_campaign');
        Route::get('/edit/{id}', 'CampaignController@edit')->middleware('edit_campaign');
        Route::post('/update', 'CampaignController@update')->middleware('edit_campaign');
        Route::post('/delete', 'CampaignController@delete')->middleware('delete_campaign');
        Route::get('/filter', 'CampaignController@filter')->middleware('view_campaign');
        Route::get('/print-tickets/{id}', 'CampaignController@print')->middleware('view_campaign');
        Route::get('/pick-winner/{id}', 'CampaignController@pickwinner')->middleware('view_campaign');
        Route::get('/selected-winner/{campaign_id}/{}customer_id', 'CampaignController@selectedwinner')->middleware('view_campaign');
         Route::get('/changestatus/{id}', 'CampaignController@changecamstatus')->middleware('delete_campaign');
         Route::post('pick-winner','CampaignController@addPickWinner')->middleware('add_campaign');
         Route::get('winner-email','CampaignController@winnerEmail')->middleware('view_campaign');
         Route::post('send-winner-email','CampaignController@sendWinnerListMail');

    });
    Route::group(['prefix' => 'admin/reward', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        Route::get('/list-rewards', 'RewardController@display')->name('view_reward');
        Route::get('/add', 'RewardController@add')->name('add_reward');
        Route::post('/insert', 'RewardController@insert')->name('add_reward');
        Route::get('/edit/{id}', 'RewardController@edit')->name('edit_reward');
        Route::post('/update', 'RewardController@update')->name('upadate_reward');
        Route::post('/delete', 'RewardController@delete')->name('delete_reward');
        Route::get('/filter', 'RewardController@filter')->name('view_reward');
    });
    Route::group(['prefix' => 'admin/winners', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        Route::get('/display', 'WinnerController@display')->name('view_winner');
        Route::get('/add', 'WinnerController@add')->name('add_winner');
        Route::post('/insert', 'WinnerController@insert')->name('add_winner');
        Route::get('/edit/{id}', 'WinnerController@edit')->name('edit_winner');
        Route::post('/update', 'WinnerController@update')->name('upadate_winner');
        Route::post('/delete', 'WinnerController@delete')->name('delete_winner');
    });
