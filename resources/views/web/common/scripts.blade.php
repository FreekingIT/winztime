...
function signupfieldvalidate()
  {
    var error = "";
    jQuery(".signup-field-validate").each(function() {
        if(this.value == '') {
          jQuery(this).closest(".form-group").addClass('has-error');
          jQuery(this).next(".error-content").removeAttr('hidden');
          error = "has error";
    ...
    var check = 0;
    var password='';
    jQuery(".signup-re_password").each(function() {
       if(jQuery(this).val() == jQuery(".signup-password").val())
       {
          jQuery(this).closest(".form-group").removeClass('has-error');
          jQuery(this).next(".error-content").attr('hidden', true);
       }else{
    ...
    jQuery(".signup-number-validate").each(function() {
      var phone = jQuery(this).val();
      var phoneNum = phone.replace(/[^\d]/g, '');
      if (phoneNum.length == 9) {
        jQuery(this).closest(".form-group").removeClass('has-error');
    ...
    jQuery(".signup-email-validate").each(function() {
        var validEmail = /^[A-Z0-9._%+-]+@([A-Z0-9-]+\.)+[A-Z]{2,4}$/i;
        if(this.value != '' && validEmail.test(this.value)) {
          jQuery(this).closest(".form-group").removeClass('has-error');
          jQuery(this).next(".error-content").attr('hidden', true);
    ...
    jQuery(".signup-checkbox-validate").each(function() {
    ...
    jQuery(".checkbox-validate").each(function() {
      ...
      if(error=="has error"){
        return false;
          ...
          jQuery(".signup-form-validate").submit();
      }
}
...
function updateCheckoutCartAjax() {
