    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        <div class="shopping-address-box">
          ...
          <div class="address-option contFormWrp checkoutForm" @isset(session('billing_address')->selectedOption) style="display:none;" @else style="display:block;" @endisset>
            ...
            @if(count($result['address']) <= 0) <form class="contctForm checkout-address-form-validate" id="asd" enctype="multipart/form-data" action="{{ URL::to('/addAddress')}}" method="post">
              ...
              <div class="row">
                ...
                <div class="form-group  col-md-6  citytext d-none">
                  <label for=""> @lang('website.City')</label>
                  <input name="city_text" value="" type="text" class="form-control  ">

                </div>
                <div class="form-group col-md-6 citydropdown">
                  <label for=""> @lang('website.City')</label>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input class="form-control checkout-contact-number-validate countrycode" id="phone" name="delivery_phone" type="tel" required="required">
                ...
                <div class="col-lg-5 col-md-5 col-sm-5">
                  <div class="cart-btn-box">
                    <div class="quantity Qty">
                      ...
                      <a href="#" class="quantity__plus qtypluscheckout" data-type="plus"><span>Add More</span></a>
                    </div>
      ...
      <div class="col-lg-4">
        ...
        <a href="javascript:;" onclick="paymentMethods();" id="card_label" class="btn payment_method"><span>Payment Method</span></a>
        @endif
      </div>
