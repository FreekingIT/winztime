					...
					<div class="wishlist-products">
						<table>
							...
							<tbody>
								...
								?>
								<tr>
									<td><!-- <h3>Buy</h3> --><figure class="productImg"><img src="{{asset('').$products->image_path}}" alt="*"></figure>{{$products->products_name}}</td>
									<!-- <td></td> -->
									<td>@if(!empty($products->discount_price))
										...
										<ul class="cartDelBtn">
											...
											<li class="anchorSwap">
												...
												<a href="javascript:;" class="cart" title="Add to cart" products_id="{{$products->products_id}}">
