							...
							<div class="row">
								...
								<div class="col-md-3">
									...
									<figure>
										...
										<img src="{{asset('web/assets/images/Silver-badge.png')}}" alt="*">
								...
								<div class="col-md-9">
									...
									<p style="float: right;"><strong>Available Z-Points: {{number_format(auth()->guard('customer')->user()->redeem_points)}}</strong></p>

									<figcaption>

										<h3>{{$result['current'][0]->name}}</h3>

										<p>You now earn @if($result['current'][0]->id == 1) {{$result['commonContent']['setting'][130]->value}} @elseif($result['current'][0]->id == 2) {{$result['commonContent']['setting'][131]->value}} @else {{$result['commonContent']['setting'][132]->value}} @endif Z-Points on every AED100 spent for a 12 month trailing period</p>
							...
							<div class="row">
								...
								<div class="col-md-3">
									...
									<figure>
										...
										@if($level->id == 1) <img src="{{asset('web/assets/images/Silver-badge.png')}}" alt="*">  @elseif($level->id == 2) <img src="{{asset('web/assets/images/Gold-badge.png')}}" alt="*"> @else <img src="{{asset('web/assets/images/Platinum-badge.png')}}" alt="*">@endif
