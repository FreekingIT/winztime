...
<body style="font-family: 'Rubik', sans-serif;">
                                                ...
                                                <td align="center" valign="top" bgcolor="#000">
                                                    <table class="col-600" width="600" height="150" border="0" align="center" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="center" style="line-height: 0px;"> <a href="https://winztime.com/"><img style="display:block; line-height:0px; font-size:0px; border:0px;" src="https://winztime.com/web/assets/images/footLogo.svg" width="300" alt="logo"></a> </td>
                                                            </tr>
                        ...
                        <tbody>
                            ...
                            <!-- <tr>
								...
								font-size:30px; color:#343434; line-height:24px; font-weight: 600;">
                                        Campaign iPhone 13 Pro (128Gb)</p>
                                </td>
                            </tr> -->
                    ...
                    <table class="col-600 fourth" width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:20px; margin-right:20px; background-color:#ff3838; border-left: 1px solid #dbd9d9; border-right: 1px solid #dbd9d9;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a target="_blank" href="{{ url('/campaigns/detail') }}/{{ $cmpian['id'] }}"><img src="{{asset('images/'.$cmpian['getReward']['reward_image'])}}" class="img-fluid" alt="empty"></a>
                                </td>
                            </tr>
                            <tr>
    ...
    box-shadow: 0px 3px 4px 0px #00000033;" src="https://winztime.com/web/assets/images/partnerLogo1.webp" width="200" alt="logo"> </td>
                                            </tr>
                                            <tr>
                                                <td height="30"></td>
                                            </tr>
    ...
    box-shadow: 0px 3px 4px 0px #00000033;" src="https://winztime.com/web/assets/images/partnerLogo3.webp" width="200" alt="logo"> </td>
                                            </tr>
                                            <tr>
                                                <td height="30"></td>
                                            </tr>
