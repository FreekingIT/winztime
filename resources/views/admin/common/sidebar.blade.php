<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <?php } ?>
       <li class="treeview {{ Request::is('admin/campaign/display') ? 'active' : '' }} {{ Request::is('admin/editcampaign/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/campaign/display')}}" ><i class="fa fa-bullhorn" aria-hidden="true"></i> <span>Campaigns</span></a>
        </li>
        <li class="treeview {{ Request::is('admin/ticket/display') ? 'active' : '' }} {{ Request::is('admin/editticket/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/ticket/display')}}" ><i class="fa fa-ticket" aria-hidden="true"></i> <span>Tickets</span></a>
        </li>
        <li class="treeview {{ Request::is('admin/level/display') ? 'active' : '' }} {{ Request::is('admin/editlevel/*') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/level/display')}}" ><i class="fa fa-level-up" aria-hidden="true"></i> <span>Levels</span></a>
        </li>
        <li class="treeview {{ Request::is('admin/reward/list-rewards') ? 'active' : '' }} {{ Request::is('admin/reward/add') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/reward/list-rewards')}}" ><i class="fa fa-bullhorn" aria-hidden="true"></i> <span>Rewards</span></a>
        </li>
        <li class="treeview {{ Request::is('admin/winners/display') ? 'active' : '' }} {{ Request::is('admin/winners/add') ? 'active' : '' }}">
          <a href="{{ URL::to('admin/winners/display')}}" ><i class="fa fa-trophy" aria-hidden="true"></i> <span>Winners</span></a>
        </li>
      <?php
      ...
      <li class="{{ Request::is('admin/orders/display') ? 'active' : '' }} {{ Request::is('admin/orders/vieworder/*') ? 'active' : '' }}">
              <a href="{{ URL::to('admin/orders/display')}}" >
                <i class="fa fa-list-ul" aria-hidden="true"></i> <span> {{ trans('labels.link_orders') }}</span>
              </a>
            </li>
      <?php } ?>
      <?php
  ...
  <span>{{ trans('labels.link_reports') }}</span> <i class="fa fa-angle-left pull-right"></i>
      ...
      <?php } ?>
      <?php
          //f($result['commonContent']['roles']!= null and $result['commonContent']['roles']->coupons_view ==1){
        ?>
...
<span>{{ trans('labels.link_notifications') }}</span> <i class="fa fa-angle-left pull-right"></i>
  ...
  <span> {{ trans('labels.link_general_settings') }}</span> <i class="fa fa-angle-left pull-right"></i>
      ...
      <?php } ?>
      <li class="treeview {{ Request::is('admin/home_winners') ? 'active' : '' }} ">
        <a href="{{ URL::to('admin/home_winners')}}"><i class="fa fa-trophy"></i> {{ trans('labels.Winners') }}</a></li>

        <li class="treeview {{ Request::is('admin/winner-email') ? 'active' : '' }} ">
        <a href="{{ URL::to('admin/campaign/winner-email')}}"><i class="fa fa-trophy"></i> Winner Email</a></li>
