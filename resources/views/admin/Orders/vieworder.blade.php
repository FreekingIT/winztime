      ...
      <div class="row invoice-info">
          ...
          <div class="orderInerWrp">
            ...
            <address>
              <ul>
                ...
                <li><strong>Address: </strong>{{ $data['orders_data'][0]->customers_suburb }}, {{ $data['orders_data'][0]->customers_street_address }}, {{ $data['orders_data'][0]->customers_city }}, {{ $data['orders_data'][0]->customers_country }}</li>
        ...
        <div class="col-sm-6 invoice-col">
          <div class="orderInerWrp">
            ...
            <address>
              <ul>
                <li style="text-transform: capitalize;"><strong>Name: </strong>{{ $data['orders_data'][0]->billing_name }}</li>
                <li><strong>Address: </strong>{{ $data['orders_data'][0]->billing_suburb }}, {{ $data['orders_data'][0]->billing_street_address }}, {{ $data['orders_data'][0]->billing_city }}, {{ $data['orders_data'][0]->billing_country }}</li>
                <li><strong>{{ trans('labels.Phone') }}: </strong>{{ $data['orders_data'][0]->billing_phone }}</li>
                <li><strong>{{ trans('labels.Email') }}: </strong>{{ $data['orders_data'][0]->email }}</li>
                <!-- <li><strong>Location</strong></li> -->
              </ul>
